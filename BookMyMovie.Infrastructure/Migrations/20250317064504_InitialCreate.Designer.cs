...
namespace BookMyMovie.Infrastructure.Migrations
{
    ...
    [Migration("20250317064504_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScreenScreenShowTime", b =>
                {
                    b.Property<Guid>("ScreenShowTimesId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ScreensId")
                        .HasColumnType("uuid");

                    b.HasKey("ScreenShowTimesId", "ScreensId");

                    b.HasIndex("ScreensId");

                    b.ToTable("ScreenScreenShowTime");
                });
            ...
            modelBuilder.Entity("ScreenScreenShowTime", b =>
                {
                    b.HasOne("BookMyMovie.Domain.Entities.ScreenShowTime", null)
                        .WithMany()
                        .HasForeignKey("ScreenShowTimesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
